 ...
 **/ 
typedef struct clause_index3 {
  int clause;
  int index;
} clause_index3;

typedef struct literal3 {
 ...
 * 
 **/
typedef struct lit_clauses3 {
  literal3 lit;
  int num_clauses;
  int cur_clause;
  int purity;
  int num_unsatisfied;
  clause_index3 * clauses;
} lit_clauses3;

typedef struct clause3 {
  int len;
  int num_unassigned;
  literal3 *lits;
  int is_satisfied;
